      ...
      <BackgroundGradient className="p-4 rounded-xl">
        <Card className="bg-[#050217] border border-gray-700 p-8 rounded-xl shadow-lg">
          <div className="text-center text-gray-300">
            ...
            <p className="mt-2 text-lg">Please wait while we load your badges 😊</p>
          </div>
        </Card>
      </BackgroundGradient>
    </div>
  ...
  <div className="w-full flex justify-center p-6">
    <div className="w-full max-w-5xl">
      <BackgroundGradient className="p-4 rounded-xl">
        <Card className="bg-[#050217] border border-gray-700 p-8 rounded-xl shadow-lg">
          <div className="text-center text-gray-300">
            <div className="flex justify-center mb-4 text-4xl text-red-500">❌</div>
            <h2 className="text-3xl text-[#c8c7cc] font-semibold">
...
export default function Badges() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      try {
        setBadges(dummyBadges); // Simulate setting badges data
        setLoading(false);
      } catch (err) {
          ...
          <div className="max-h-[145vh] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-purple-500 scrollbar-track-transparent">
            ...
            {sortedBadges.map((badge) => (
              <div key={badge.id} className="transform transition-all duration-300 hover:scale-105">
                ...
                >
                  <Card className={`bg-[#050217] border ${
                    badge.unlocked ? "border-purple-500/50" : "border-gray-700"
                    ...
                    <div className="flex flex-col items-center justify-center text-center">
                      ...
                      <h2 className={`text-xl font-semibold ${
                        badge.unlocked ? "text-purple-300" : "text-gray-400"
                      }`}>
                        {badge.title}
                      </h2>
